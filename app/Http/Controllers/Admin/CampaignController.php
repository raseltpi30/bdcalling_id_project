    ...
    public function store(Request $request)
    {
        ...
        $data['year']=date('Y');
         //working with image
          ...
          $image = $image->resize(468,90);  //image intervention
          $image->toJpeg(80)->save(base_path('public/files/campaign/'.$photoname));
        $data['image']= $photoname;   // public/files/brand/plus-point.jpg
