						  ...
						  <form action="{{route('order.place')}}" method="post" id="order-place">
							...
							<div class="row p-4">
							  <div class="form-group col-lg-6">
								...
								<input type="text" class="form-control" value="{{ Auth::user()->name }}" name="c_name" required="" id="c_name">
							  </div>
							  <div class="form-group col-lg-6">
								<label for="c_phone">Customer Phone <span class="text-danger">*</span></label>
								<input type="text" class="form-control" value="{{ Auth::user()->phone }}" name="c_phone" required="" id="c_phone">
							  </div>
							  <div class="form-group col-lg-6">
								<label for="c_country"> Country <span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="c_country" required="" id="c_country">
							  </div>
							  <div class="form-group col-lg-6">
								<label for="c_address">Shipping Address <span class="text-danger">*</span> </label>
								<input type="text" class="form-control" name="c_address" required="" id="c_address">
							  </div>
							  
							  <div class="form-group col-lg-6">
								<label for="c_email">Email Address</label>
								<input type="text" class="form-control" name="c_email" id="c_email" value="{{Auth::user()->email}}">
							  </div>
							  <div class="form-group col-lg-6">
								<label for="c_zipcode">Zip Code</label>
								<input type="text" class="form-control" name="c_zipcode" required="" id="c_zipcode">
							  </div>
							  <div class="form-group col-lg-6">
								<label for="c_city">City Name</label>
								<input type="text" class="form-control" name="c_city" required="" id="c_city">
							  </div>
							  <div class="form-group col-lg-6">
								<label for="c_extra_phone">Extra Phone</label>
								<input type="text" class="form-control" name="c_extra_phone" required="" id="c_extra_phone">
							  </div>
								<br>
