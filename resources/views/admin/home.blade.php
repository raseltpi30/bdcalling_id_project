        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Coupon</span>
                <span class="info-box-number">
                  {{$coupon}}
                </span>
              </div>
              ...
              <div class="card-body p-0">
                <ul class="users-list clearfix">
                  ...
                  <li>
                    ...
                    <h1>faka</h1>
                    @else
                     <img src="{{ asset('files/profile/'.$cus->profile_picture) }}" style="height:70px;width:70px;object-fit:cover;">
                    @endif
