                    ...
                    <form action="{{ route('city.store') }}" method="Post">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="name" class="col-sm-4 col-form-label text-right">City Name *</label>
                                <div class="col-sm-8">
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="City Name">
                                    <small id="emailHelp" class="form-text text-muted">This is your City Name</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="category_id" class="col-sm-4 col-form-label text-right">Country Name
                                    *</label>
                                <div class="col-sm-8">
