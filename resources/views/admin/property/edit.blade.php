                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">property Name <span
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="category_id" id="subcategory_id">
                                                @foreach ($category as $row)
                                                    <option value="{{ $row->id }}"
                                                        @if ($row->id == $property->category_id) selected @endif>
                                                        {{ $row->category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="exampleInputEmail1">Country<span class="text-danger">*</span>
                                            </label>
                                            <select class="form-control" name="country_id" id="subcategory_id">
                                                @foreach ($country as $row)
                                                    <option value="{{ $row->id }}"
                                                        @if ($row->id == $property->country_id) selected @endif>
                                                        {{ $row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="city_id" id="subcategory_id">
                                                @foreach ($city as $row)
                                                    <option value="{{ $row->id }}"
                                                        @if ($row->id == $property->city_id) selected @endif>
                                                        {{ $row->city_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="exampleInputEmail1">Property Size<span class="text-danger">*</span>
                                            </label>
                                            <select class="form-control" name="property_size_id" id="subcategory_id">
                                                @foreach ($property_size as $row)
                                                    <option value="{{ $row->id }}"
                                                        @if ($row->id == $property->property_size_id) selected @endif>
                                                        {{ $row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="exampleInputEmail1">Property Type<span class="text-danger">*</span>
                                            </label>
                                            <select class="form-control" name="property_type_id" id="subcategory_id">
                                                @foreach ($property_type as $row)
                                                    <option value="{{ $row->id }}"
                                                        @if ($row->id == $property->property_type_id) selected @endif>
                                                        {{ $row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="exampleInputEmail1">Amenity<span class="text-danger">*</span>
                                            </label>
                                            <select class="form-control" name="property_amenity_id" id="subcategory_id">
                                                @foreach ($amenity as $row)
                                                    <option value="{{ $row->id }}"
                                                        @if ($row->id == $property->property_amenity_id) selected @endif>
                                                        {{ $row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $property->starting_price }}" name="starting_price">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="exampleInput">Selling Price <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" name="selling_price"
                                                value="{{ $property->selling_price }}" class="form-control" required="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="exampleInput">Stock Qantity<span class="text-danger">*</span>
                                            </label>
                                            <input type="number" name="stock_quantity"
                                                value="{{ $property->stock_quantity }}" class="form-control"
                                                required="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label for="exampleInput">Bath Rooms <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" name="bathroom" value="{{ $property->bathroom }}"
                                                class="form-control" required="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="exampleInput">Flat Side <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" name="flatside" value="{{ $property->flatside }}"
                                                class="form-control" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea class="form-control" name="address">{{ $property->address }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label for="exampleInputPassword1">Map Url</label>
                                            <textarea class="form-control" name="map_url">{{ $property->map_url }}</textarea>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <img src="{{ asset('files/property/' . $property->thumbnail) }}"
                                                    ...
                                                    <div class="row">
                                                        @foreach ($images as $key => $image)
                                                            <div class="col-md-4 new-image">
                                                                <img alt=""
                                                                    src="{{ asset('files/property/' . $image) }}"
                                        ...
                                        <button class="btn btn-info ml-2" type="submit">Update Property</button>
                                    </div>
                                    <!-- /.card-body -->
                                </div>
                                <!-- /.card -->
