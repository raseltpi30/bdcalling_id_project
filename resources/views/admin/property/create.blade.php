                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="form-group col-lg-4">
                      ...
                      <input type="text" class="form-control" {{ old('starting_price') }} name="starting_price">
                    </div>
                    <div class="form-group col-lg-4">
                      <label for="exampleInput">Selling Price <span class="text-danger">*</span> </label>
                      <input type="text" name="selling_price" {{ old('selling_price') }} class="form-control" required="">
                    </div>
                    <div class="form-group col-lg-4">
                      <label for="exampleInput">Stock Qantity<span class="text-danger">*</span> </label>
                      <input type="number" name="stock_quantity" {{ old('stock_quantity')}} class="form-control" required="">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-lg-4">
                      <label for="exampleInput"> Bed Rooms </label>
                      <input type="text" class="form-control" {{ old('bedroom') }} name="bedroom">
                    </div>
                    <div class="form-group col-lg-4">
                      <label for="exampleInput">Bath Rooms <span class="text-danger">*</span> </label>
                      <input type="text" name="bathroom" {{ old('bedroom') }} class="form-control" required="">
                    </div>
                    <div class="form-group col-lg-4">
                      <label for="exampleInput">Flat Side <span class="text-danger">*</span> </label>
                      <input type="text" name="flatside" {{ old('flatside') }} class="form-control" required="">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="form-group col-lg-12">
                      ...
                      <textarea class="form-control textarea" name="address">{{ old('address') }}</textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-lg-12">
                      <label for="exampleInputPassword1">Map Url</label>
                      <textarea class="form-control textarea" name="map_url">{{ old('map_url') }}</textarea>
                    </div>
                  </div>
            ...
            <div class="card card-primary">
              <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="file" {{old('thumbnail')}} name="thumbnail" required="" accept="image/*" class="dropify">
                  </div><br>
                  <div class="">  
